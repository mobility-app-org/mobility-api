...
public class OfficeService {
    ...
    public void updateDispatch(Long dispatchId,  UpdateDispatchReq updateDispatchReq) {
        ...
        if (updateDispatchReq.getStartLocation() != null) {
            dispatch.setStartLocation(updateDispatchReq.getStartLocation());
        }

        if (updateDispatchReq.getDestinationLocation() != null) {
            dispatch.setDestinationLocation(updateDispatchReq.getDestinationLocation());
        }

        if (updateDispatchReq.getCharge() != null) {
            dispatch.setCharge(updateDispatchReq.getCharge());
        }

        if (updateDispatchReq.getClientPhoneNumber() != null) {
            dispatch.setClientPhoneNumber(updateDispatchReq.getClientPhoneNumber());
        }

        if (updateDispatchReq.getStatus() != null) {
            dispatch.setStatus(updateDispatchReq.getStatus());
        }

        if (updateDispatchReq.getCall() != null) {
            dispatch.setCall(updateDispatchReq.getCall());
        }

        if (updateDispatchReq.getActive() != null) {
            dispatch.setActive(updateDispatchReq.getActive());
        }

        if (updateDispatchReq.getService() != null) {
            dispatch.setService(updateDispatchReq.getService());
        }
